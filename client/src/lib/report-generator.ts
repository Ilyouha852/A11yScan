import type { AccessibilityCheck, ViolationDetail } from "@shared/schema";
import { translateViolationHelp, translateViolationDescription, translateFailureSummary, translateHTMLValidationMessage } from "./translations";
